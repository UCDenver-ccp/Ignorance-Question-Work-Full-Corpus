...
new_articles_path='Ignorance-Question-Work-Full-Corpus/New_Articles/New_Articles_Annotation_Task_Eric_12.6.21_automatic_classifiers/'
erics_folder='New_Articles_Annotation_Task_Eric_12.6.21_automatic_classifiers/'
