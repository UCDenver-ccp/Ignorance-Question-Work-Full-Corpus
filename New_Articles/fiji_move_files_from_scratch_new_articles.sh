...
output_models_path='Ignorance-Question-Work-Full-Corpus/New_Articles/Word_Analysis_Output_Results/'
biobert_folder='BioBERT_Classification_Results/'
crf_folder='CRF_Classification_Results/'
