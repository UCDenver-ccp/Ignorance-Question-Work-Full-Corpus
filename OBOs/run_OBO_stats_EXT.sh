...
OBO_ontologies="CHEBI_EXT,CL_EXT,GO_BP_EXT,GO_CC_EXT,GO_MF_EXT,MOP_EXT,NCBITaxon_EXT,PR_EXT,SO_EXT,UBERON_EXT"
#OBO_ontologies='CHEBI_EXT'
...
OBO_model_dict="{'CHEBI_EXT':'BIOBERT','CL_EXT':'BIOBERT','GO_BP_EXT':'BIOBERT','GO_CC_EXT':'BIOBERT','GO_MF_EXT':'BIOBERT','MOP_EXT':'BIOBERT','NCBITaxon_EXT':'CRF','PR_EXT':'BIOBERT','SO_EXT':'BIOBERT','UBERON_EXT':'BIOBERT'}"
