...
#    ontologies='1_binary_combined'
    ...
    python3 biobert_eval_dataframe_output.py -ontologies=$ontologies -excluded_files=$evaluation_files -tokenized_file_path=$all_file_path$eval_path$tokenized_files -biobert_prediction_results=$all_file_path$eval_path$output_path -output_path=$all_file_path$eval_path$output_path -algos=$algos --pmcid_sentence_files_path=$pmcid_sentence_files_path
