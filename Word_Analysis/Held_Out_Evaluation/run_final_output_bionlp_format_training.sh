...
python3 final_output_bionlp_format.py -ontologies=$ontologies -algos=$algos -result_folders=$results_folders -results_path=$all_file_path$eval_path$output_results -output_folder=$output_folder -evaluation_files=$training_files -separate_all_combined_output=$separate_all_combined_output -shorthand_ont_dict=$ontology_shorthand_dict