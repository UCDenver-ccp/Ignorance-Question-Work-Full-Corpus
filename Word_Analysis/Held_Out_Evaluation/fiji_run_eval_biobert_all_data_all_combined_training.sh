...
tokenized_files='Ignorance-Question-Work-Full-Corpus/Word_Analysis/Held_Out_Evaluation/Training_Tokenized_Files/'

##the output folder for the results of running BioBERT for span detection
results_span_detection='Ignorance-Question-Work-Full-Corpus/Word_Analysis/Held_Out_Evaluation/Output_Results/BioBERT_Training_Results/'
